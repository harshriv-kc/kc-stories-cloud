...
DAY=[dict(i=1,src="subjfull_1.png",lines=["काजू","तेजी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["लॉलीपॉप","5 फ्री"],fs=FS),
     dict(i=3,src="subjfull_3.png",lines=["बारिश","अलर्ट"],fs=FS)]
