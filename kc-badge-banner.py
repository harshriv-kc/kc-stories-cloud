...
DAY=[dict(i=1,src="subjfull_1.png",lines=["हल्दी","में तेजी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["विम बार","3+1 फ्री"],fs=FS),
     dict(i=3,src="subjfull_3.png",lines=["कंपनियां लौटीं","मार्जिन बढ़ा"],fs=FS)]
