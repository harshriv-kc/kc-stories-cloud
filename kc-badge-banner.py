...
DAY=[dict(i=1,src="subjfull_1.png",lines=["गेहूं","तेजी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["हैंडवॉश","1+1 फ्री"],fs=FS),
     dict(i=3,src="subjfull_3.png",lines=["प्याज","₹35 किलो"],fs=FS)]
