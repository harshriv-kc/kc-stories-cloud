...
DAY=[dict(i=1,src="subjfull_1.png",lines=["साबूदाना","तेज़"],fs=98),
     dict(i=2,src="subjfull_2.png",lines=["पिटारा","स्कीम"],fs=118),
     dict(i=3,src="subjfull_3.png",lines=["UPI पर","शुल्क"],fs=112)]
