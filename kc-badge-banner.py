...
# 2026-09-22: mandi=काली मिर्च/तेज़ (black pepper teji, dense pepper flat-lay), fmcg=लक्स साबुन/4+1 फ्री (Lux 4+1 consumer scheme, real Lux packs), news=सब्ज़ियां/महंगी (barish se sabzi mehngi). 2-line short hooks; verify radial clearance after render.
DAY=[dict(i=1,src="subjfull_1.png",lines=["काली मिर्च","तेज़"],fs=116),
     dict(i=2,src="subjfull_2.png",lines=["लक्स साबुन","4+1 फ्री"],fs=118),
     dict(i=3,src="subjfull_3.png",lines=["सब्ज़ियां","महंगी"],fs=132)]
