...
FS=150   # 2026-08-10: uniform — lines today (बासमती तेज़ी / 6 पर 1 फ्री / दवा 90% सस्ती); re-measure max radial <=~448 after render
DAY=[dict(i=1,src="subjfull_1.png",lines=["बासमती","तेज़ी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["6 पर 1","फ्री"],fs=FS),
     dict(i=3,src="subjfull_3.png",lines=["दवा 90%","सस्ती"],fs=FS)]
if __name__=="__main__":
    render("D", DAY, TALL, 153)   # bottom recentred for FS150: 325-(2*150*1.1+14)/2 ≈ 153 (block-centering formula)
