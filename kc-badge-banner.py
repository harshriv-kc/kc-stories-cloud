...
# 2026-08-20: mandi=चना दाल महंगी(चना तेजी), fmcg=नटराज रबर फ्री(real still-life), tn=चीनी होगी सस्ती(import relief). Short 2-word lines — verify radial clearance after render.
DAY=[dict(i=1,src="subjfull_1.png",lines=["चना दाल","महंगी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["नटराज","रबर फ्री"],fs=FS),
     dict(i=3,src="subjfull_3.png",lines=["चीनी होगी","सस्ती"],fs=FS)]
