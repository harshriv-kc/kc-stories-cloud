...
# 2026-08-21: mandi=मक्का तेज़ी(corn तेजी), fmcg=निविया ₹21 सस्ता(real D2R photo, MRP ₹151->₹130), tn=बारिश अलर्ट(21-state rain). Short lines — verify radial clearance after render (₹21 सस्ता is widest).
DAY=[dict(i=1,src="subjfull_1.png",lines=["मक्का","तेज़ी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["निविया","₹21 सस्ता"],fs=FS),
