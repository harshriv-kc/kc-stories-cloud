...
# 2026-09-17: mandi=बासमती/तेज़ (basmati teji, rice flat-lay), fmcg=साबुन/4 पर 1 फ्री (Glimmer soap 4+1, REAL retailer pack), news=UPI पर/नया शुल्क (Rs2000+ 0.4% fee). All 2-line short hooks; verify radial clearance after render.
DAY=[dict(i=1,src="subjfull_1.png",lines=["बासमती","तेज़"],fs=138),           # "बासमती" wide upper line; measure
     dict(i=2,src="subjfull_2.png",lines=["साबुन","4 पर 1 फ्री"],fs=114),     # "4 पर 1 फ्री" wide lower line; measure
     dict(i=3,src="subjfull_3.png",lines=["UPI पर","नया शुल्क"],fs=124)]      # both moderate; measure
