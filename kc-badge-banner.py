...
FS=145   # 2026-07-24: keep 145 — widest line "इनो 100+2" clears the ring; re-measure radial below (<438)
DAY=[dict(i=1,src="subjfull_1.png",lines=["गुड़ में","तेजी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["इनो 100+2","फ्री"],fs=FS),
     dict(i=3,src="subjfull_3.png",lines=["दाम नहीं","बढ़ेंगे"],fs=FS)]
