...
FS=152
DAY=[dict(i=1,src="subjfull_1.png",lines=["मूंग दाल","तेजी"],fs=FS),
     dict(i=2,src="subjfull_2.png",lines=["फ्री बोतल","स्कीम"],fs=FS),
     dict(i=3,src="subjfull_3.png",lines=["त्योहारी माल","भरें"],fs=FS)]
